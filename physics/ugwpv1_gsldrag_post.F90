...
!!
     subroutine ugwpv1_gsldrag_post_run ( im, levs, ldiag3d,          &
         ldiag_ugwp, ldiag_ugwp_gsl, dtf, dudt_gw, dvdt_gw, dtdt_gw,  &
        ...
        logical,              intent(in) :: ldiag_ugwp_gsl  !< flag for CIREs UGWP with GSL drag Diagnostics
